...
export function createFish (app: PIXI.Application, organization: Organization, next: FactoryFishTask['resolve']) {
  ...
  const fish = new NPCFish(app, sprite, healthValue, Math.random() > 0.5 ? Direction.r : Direction.l)
  fish.positionOut()
  organization
    .addMaterial(fish)
  fish.startMove()
